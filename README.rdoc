...
When you want to translate the mappings, simply call Mapper.translate(:foo, source), passing the tag for the mapping and the actual source you want to translate from.
